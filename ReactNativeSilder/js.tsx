...
import {Animated, Image, StyleSheet, PanResponder, View, Easing, ViewPropTypes, I18nManager, ImageStyle} from 'react-native';
...
export default class Slider extends PureComponent {
  static propTypes = {
    ...
    valueSholudChange: PropTypes.func,
    /**
  ...
  render() {
    ...
    return (
      <View {...other} style={[mainStyles.container, style]} onLayout={this._measureContainer}>
        ...
        <View renderToHardwareTextureAndroid style={[defaultStyles.touchArea, touchOverflowStyle]} {...this._panResponder.panHandlers}>
  ...
  _getPropsForComponentUpdate(props) {
    const {value, onValueChange, onSlidingStart, onSlidingComplete, style, trackStyle, thumbStyle, ...otherProps} = props;
  ...
  _handlePanResponderMove = (e: Object, gestureState: Object) => {
    ...
    if ((this.props.valueSholudChange || (() => true))(value)) {
  ...
  _getValue = (gestureState: Object) => {
    ...
    return Math.max(
      this.props.minimumValue,
      Math.min(this.props.maximumValue, ratio * (this.props.maximumValue - this.props.minimumValue) + this.props.minimumValue)
    );
  };
